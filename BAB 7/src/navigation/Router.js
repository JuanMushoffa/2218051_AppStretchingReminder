...
import { HomeScreen, DiscoverScreen, BookmarkScreen, Profile, DetailScreen, AddStretchForm, EditStretchForm } from '../screens';
...
function MainTab() {
  return (
    <Tab.Navigator screenOptions={{
      ...
      <Tab.Screen name="Discover Screen" component={DiscoverScreen} options={{
        tabBarIcon: ({ color, focused }) => (
          <LocationDiscover color={color} variant={focused ? 'Bold' : 'Linear'} size={24} />
        ),
        headerShown: false,
      }} />
      <Tab.Screen name="Bookmark Screen" component={BookmarkScreen} options={{
        tabBarIcon: ({ color, focused }) => (
